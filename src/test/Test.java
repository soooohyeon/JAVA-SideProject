	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:// 회원가입
				...
				id = sc.next();
				if(userDAO.checkID(id) > 0) { // 입력한 아이디 중복검사
				...
				if (userDAO.login(id, password) > 0) {
					...
					while(run) {
						...
						case 4:// 4.좋아하는 선수의 경기 일정
							System.out.println("\n=================================");
							System.out.println("🎉" + userDAO.findPlayerInfo(userDAO.findPlayerNumber()) + "  선수의 경기 일정을 조회합니다...🎉");
							System.out.println("=================================\n");
							functionDAO = new FunctionDAO();
							System.out.println("\n=================================");
							System.out.println("🎉" + userDAO.findPlayerInfo(userDAO.findPlayerNumber()) + "  선수의 경기 일정!🎉");
							System.out.println("=================================\n");
							System.out.println(functionDAO.gameSchedule(userDAO.findPlayerInfo()));
							//좋아하는 선수가 속한 팀명을 매개변수로 넣기
							break;
						...
						case 7:// 7.내 정보 조회(마이 페이지)
							...
							System.out.println("좋아하는 팀 : " + userDAO.findTeamName((userDAO.selectUser().getUserLikeTeam())));
